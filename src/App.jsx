...
function App() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#f0f2f5] dark:bg-gray-900 transition-colors duration-300">
      <Sidebar />

      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        
        {/* --- 动态顶部 Header Tab 栏 --- */}
        <div className="h-9 bg-[#001529] dark:bg-black flex items-center px-2 shrink-0 shadow-sm overflow-x-auto no-scrollbar transition-colors duration-300">
              ...
              return (
                <div 
                  ...
                  className={`group px-3 py-1 text-[11px] rounded-t-sm flex items-center cursor-pointer transition-all duration-200 min-w-[80px] justify-between
                    ${isActive 
                      ? 'bg-[#f0f2f5] dark:bg-gray-900 text-blue-600 dark:text-blue-400 font-bold' 
                      : 'bg-white/10 dark:bg-white/5 text-gray-400 hover:bg-white/20 hover:text-white'
                    }`}
                >
                  ...
                  <X 
                    ...
                    className={`ml-2 opacity-0 group-hover:opacity-100 hover:bg-red-500 hover:text-white rounded-full p-[1px] transition-all
                      ${isActive ? 'opacity-40 text-gray-500 dark:text-gray-400' : ''}`}
